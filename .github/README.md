...
[`@aws-sdk/client-api-gateway`](https://www.npmjs.com/package/@aws-sdk/client-api-gateway/v/3.495.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-api-gateway@3.495.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LnGeBgWBXVLcHtNi32lZndo7/MOMyPZEUJ8koHJ+/K/J+HuX9hn91yjKk1yhMlvR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-api-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-api-gateway@3.495.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-api-gateway@3.495.0/index.min.mjs": "sha384-LnGeBgWBXVLcHtNi32lZndo7/MOMyPZEUJ8koHJ+/K/J+HuX9hn91yjKk1yhMlvR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-api-gateway/blob/refs/tags/3.495.0/LICENSE
```
