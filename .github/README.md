...
[`@aws-sdk/client-api-gateway`](https://www.npmjs.com/package/@aws-sdk/client-api-gateway/v/3.19.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-api-gateway@3.19.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Sum338qN8ccSRv24n/WKRhd6X+ganAHceXCVlp26SxFS7U2aAGpDRICj7qzFaclq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-api-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-api-gateway@3.19.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-api-gateway@3.19.0/index.min.mjs": "sha384-Sum338qN8ccSRv24n/WKRhd6X+ganAHceXCVlp26SxFS7U2aAGpDRICj7qzFaclq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-api-gateway/blob/refs/tags/3.19.0/LICENSE
```
